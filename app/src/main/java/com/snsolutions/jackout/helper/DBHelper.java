...
public class DBHelper {
    ...
    public DBHelper() {
        this.productArrayList.add(new Product(10.10, "Vassoura", 103, 30));
        this.productArrayList.add(new Product(10.10, "Vassoura", 103, 30));
        this.productArrayList.add(new Product(9.95, "Pepino", 104, 30));
        this.productArrayList.add(new Product(9.95, "Pepino", 104, 30));
        this.productArrayList.add(new Product(30.31, "Tesoura", 105, 30));
        this.productArrayList.add(new Product(30.31, "Tesoura", 105, 30));
    };
